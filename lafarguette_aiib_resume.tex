...
\begin{itemize}
  ...
  \item Develop and maintain portfolios risk systems (CVaR \& DD limits, risk exposures, multivariate risk factors, stress-tests, early warning signals, etc.), automatize risk reporting, engagement with discretionary managers 
...
\begin{itemize}[]
  \item Banking stress-tests (FSAP) and technical assistance missions in modeling to 30+ central banks
  \begin{itemize}
  \item Solvency and liquidity stress-tests, macro models for risk scenarios (Growth-at-Risk)  
  \item Risk and liquidity management frameworks and FX reserves management tools 
  \end{itemize}
  \item EM country risk models and policy work for IMF funding programs
  \end{itemize}  
...
\begin{rubriquetableau}[0.98\textwidth]{Skills}
  ...
  \begin{itemize}
    ...
    \item \textbf{Risk models}: VaR, CVaR, ES, stress-testing, early-warning signals, credit \& FX risk modeling, pricing tools
