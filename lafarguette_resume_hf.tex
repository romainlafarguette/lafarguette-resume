...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  ...
  \begin{itemize}
    ...
    \item Models: time series, ML, gen AI, optimization, factors and risk models
    \item Development: signal productionalization, CI/CD, cloud computing, portfolio analytics, etc.
  \end{itemize}
...
\begin{itemize}
  ...
  \item Mid-frequency fundamental macro, flows and sentiment signals; signal aggregation and portfolio construction
  \item Research topics: FX and curve models, flows \& valuations, high-freq alternative data, AI synthetic data
  \item Quant prod: Github CI/CD, cloud platform (Databricks \& AWS), DAG orchestration, SQL \& Polars 
...
\begin{itemize}[]
  \item Large EM coverage (China, India, Korea, Malaysia, Israel, Peru, etc.) with more than 30 countries missions
  \end{itemize}
