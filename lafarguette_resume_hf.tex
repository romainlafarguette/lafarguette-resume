...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
    \item Lead quant researcher with 13+ years experience, specialized on rates, FX and credit
    \item Mid-freq fundamental macro, flows and sentiment signals; signal aggregation and portfolio construction
...
\begin{itemize}
  \item Senior vice-president, focus on DM/EM rates, credit, FX, and multi-asset books
  \item Mid-freq fundamental macro, flows and sentiment signals; signal aggregation and portfolio construction
  \item Research topics: FX and curve models, flows \& valuations, high-freq alternative data, AI synthetic data
  \item Quant prod: Github CI/CD, cloud platform (Databricks \& AWS), Airflow schedulers 
...
\begin{itemize}[]
\item Systematic macro signals and strategies (rates, FX, commods) for ADIA quant team ("Q")
