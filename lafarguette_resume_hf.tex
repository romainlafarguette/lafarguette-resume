...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
    \item Lead quant researcher with 13+ years of experience in global macro teams of large investment funds (GIC, ADIA) and international financial institutions (IMF, ECB)
    \item Focus on rates and FX, credit and multi-assets books
    \item Quant research: stats, ML, gen AI, portfolio construction \& optimization, factors and risk models
    \item Quant development: signal productionalization, CI/CD, cloud computing, portfolio analytics, etc.
  \end{itemize}
...
\begin{itemize}
  ...
  \item Quant research: FX and curve models, flows \& valuations, high-freq alternative data, AI synthetic data
