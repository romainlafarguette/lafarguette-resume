...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead quant strategist, 13+ years experience, managing quant teams to oversee \$100+bn multi-asset portfolios 
  \item Statistics, machine learning \& AI for portfolio analytics, risk models and global markets quant research    
  \end{itemize}
...
\activite{GIC} Lead Quant Strategist, Senior Vice President, Global Markets Multi-Assets \hfill
Singapore, since 2023 \\ \vspace{-0.4cm}
\begin{itemize}
  \item Lead and mentor a team of six quants on portfolio management and risk models, quant market research
  \item Design and implement portfolio construction and risk models for \$100+bn multi-asset portfolios
  \item Architect portfolio risk tools: CVaR \& DD limits, risk factors, stress-tests, early warning signals 
  \item Steer quant research using Machine Learning/AI/LLM on rates, FX, and credit markets 
  \item Design cloud platforms, automatize performance \& risk reporting and engage with decision makers 
\end{itemize} 

\vspace{0.4cm}

\activite{ADIA} Senior Quant Researcher, Portfolio Analytics \& Market Research  \hfill
Abu Dhabi, 2022-2023 \\ \vspace{-0.2cm}
\begin{itemize}[]
\item Portfolio construction and risk models, supporting CIO tactical tilts and FX / duration hedging 
\item Advanced macro research across global rates, FX, and commodity to identify opportunities and risk
 \end{itemize}
 
\vspace{0.4cm}

\activite{International Monetary Fund} Quant Financial Sector Expert \hfill Washington DC, 2016-2022 \\
\vspace{-0.2cm}

\begin{itemize}[]
  \item Bank stress-tests (FSAP) and technical assistance missions on quant modeling in 30+ EM countries
  \begin{itemize}
  \item Solvency and liquidity stress-tests, capital adequacy, macro models for risk scenarios (Growth-at-Risk)  
  \item Risk and liquidity management frameworks, FX reserves management tools, financial stress indices 
  \end{itemize}
...
\activite{European Central Bank} Portfolio Manager and Quant Researcher \hfill Frankfurt, 2013-2016 \\
\vspace{-0.2cm}

\begin{itemize}[]
  \item Managed RMB and JPY reserve portfolios and supported QE market operations
  \begin{itemize}
  \item Portfolio management and risk modeling for ECB rates and FX portfolios 
  \end{itemize}
\end{itemize}
\end{rubriquetableau}
...
\begin{rubriquetableau}[0.98\textwidth]{Skills}
  ...
  \begin{itemize}
    ...
    \item \textbf{Tech stack:} Python, Github CI/CD, cloud computing (AWS \& Databricks), Airflow schedulers, big data 
