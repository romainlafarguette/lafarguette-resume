...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead quant strategist managing quantitative teams to oversee \$100+bn multi-asset portfolios 
  \item Specialized in designing strategic risk frameworks, early warning systems, and advanced market analytics to support institutional decision-making  
  \end{itemize}
...
\begin{itemize}
  ...
  \item Develop and maintain portfolios risk systems (CVaR \& DD limits, risk exposures, multivariate risk factors, stress-tests, early warning signals, etc.), automatize risk reporting, engagement with decision makers 
...
\item Quant research on global rates, FX, credit and commodity markets
 \end{itemize}
 
\vspace{0.4cm}

\activite{International Monetary Fund} Global Advisory, Financial Sector Expert \hfill Washington DC, 2016-2022 \\
\vspace{-0.2cm}

\begin{itemize}[]
  \item Bank stress-tests (FSAP) and technical assistance missions in modeling in 30+ EM countries
  \begin{itemize}
  ...
  \end{itemize}
  \item Sovereign risk models and policy work for IMF funding programs
  \end{itemize}  
...
\begin{rubriquetableau}[0.98\textwidth]{Skills}
  \vspace{-0.5cm}  
  \begin{itemize}
    \item \textbf{Quant skills:} Statistics \& machine learning, convex optimization, bootstrapping, density models, AI \& LLM
