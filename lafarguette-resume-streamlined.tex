%% Time-stamp: <2023-05-16 20:15:53 A13258Q>
...
Developer \hfill Since 2022 \\ \vspace{-0.2cm}
\begin{itemize}[label={},
rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item Buy-side macro-quant, ADIA quant team ("Q")
\item Dynamic  assets allocation  and quantitative total  portfolio management
(TPM)
\item Development of  quantitative tools to address the specific  needs of TPM
  for a large sovereign wealth fund

\item Dynamic asset allocation against a policy benchmark under a risk budget
  \begin{itemize}
  \item Estimation of macro-regimes and cycles to polarize asset allocations based on diversification/performance
  \item Portfolio construction 
  \item Minimization of rebalancing costs
  \end{itemize}

  
\item Articulation between discretionary investment and quantitative models
  \begin{itemize}
  \item Developing explanaible models in performance/risk attribution, including local interpretation
  \item Integration of priors/views from senior management in quantitative models using Bayesian tools
  \item Portfolio construction integrating non-gaussian views via modified Black-Litterman and goal-based optimization
  \item Results presentation to the senior management in a clear, non-technical way with clear actionable recommendations
  \end{itemize}
  


\item Building risk models leveraging macro factors
  
\item Integration of alternative data into macro-modeling
  \begin{itemize}    
  \item Dealing with limiting historical depth, attrition, unbalanced samples
  \item Mixed frequency modeling
  \item Reconciliation between standard macro information, market expectations and alternative data signals
  \end{itemize}

\item Macro factor timing
  
\item  Forecasting, nowcasting,  risk  modeling, big  data, machine  learning,
...
Assistance Mission Chief \hfill 2016-2022 \\ \vspace{-0.2cm}
...
\item Missions to 25 countries: macrofinancial  modeling, IMF lending programs and technical assistance to central banks on quantitive methods
  ...
  \item Monetary and financial modeling under Python
  \end{itemize}
 \end{itemize}
...
\item Foreign reserves portfolio manager, Eurosystem Asian currencies portfolio (RMB \& JPY)
\item Portfolio management and tactical allocation
\item Mathematical portfolio optimization, risk modeling, forecasting  
\end{itemize}
\end{rubriquetableau}
