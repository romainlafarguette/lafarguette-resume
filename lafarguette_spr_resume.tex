...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead quant strategist with 13+ years experience across GIC, ADIA, IMF \& ECB 
...
\activite{GIC} Lead Quant Strategist, Senior Vice President, Global Markets \hfill
Singapore, since 2023 \\ \vspace{-0.4cm}
\begin{itemize}
  \item Mentor a team of five quants focused on asset allocation and sophisticated portfolio construction
...
\activite{ADIA} Senior Quant Portfolio Strategist, Global Markets  \hfill
...
\begin{rubriquetableau}[0.95\textwidth]{Education}\\
  ...
  \activite{Ph.D. Theoretical Economics,} Peking University \hfill Beijing 2013\\ 
\vspace{-0.5cm}  
  \begin{itemize}[label={},
  ...
  \item Quantitative macroeconomics, finance, machine learning, optimization
  \end{itemize}
  
  \vspace{0.2cm}
  
  \activite{M.Sc. Applied Mathematics and Statistics,} ENSAE Paris \hfill Paris 2007\\
  \vspace{0.2cm}
  \end{rubriquetableau}
\newpage
