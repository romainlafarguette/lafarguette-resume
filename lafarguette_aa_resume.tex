...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  ...
  \item Specialized in portfolio construction, systematic asset allocation, and macro trading strategies. 
  \item Proven track record in integrating quantitative research with discretionary judgment to generate alpha and manage multi-asset portfolios.
  \end{itemize}
...
\begin{itemize}
  \item Develop and deploy quant models for asset allocation, portfolio construction and risk management.
  \begin{itemize}
    \item Contributed to >100 bn AUM portfolio construction across GIC fixed income and multi-assets books. 
    \item Implementation of overlays and hedging solutions, increased diversification and drawdown control
  \end{itemize}
  \item Manage a team of 5 quants covering DM/EM rates, FX, commodities and portfolio construction.
\end{itemize} 
...
\begin{itemize}[]
\item Developed and backtested systematic macro signals for fixed income and cross-asset strategies, directly informing ADIA CIO's strategic and tactical allocation calls.
\item Quant signals on rates, FX and commodities strategies.
 \end{itemize}
...
\begin{itemize}[]
  \item International macroeconomist, led macro modeling and forecasting missions for >30 economies, shaping policy and investment frameworks for central banks
  \end{itemize}
...
\begin{itemize}[]
  \item DG Market Operations, FX reserves management and ECB QE implementation. 
\end{itemize}
\end{rubriquetableau}
...
\begin{rubriquetableau}[0.98\textwidth]{Skills}
  \vspace{-0.5cm}  
  \begin{itemize}
    \item \textbf{Languages:} Chinese Mandarin (conversational), English (fluent), French (native)
    \item \textbf{Analytics:} Optimization, statistical simulation and inference, machine learning and LLM 
    \item \textbf{Programming:} Python (quant libraries, CI/CD, AWS deployment), SQL, R
    \item \textbf{Data:} Standard (Bloomberg, Macrobond, Wind, etc.) and alternative data 
  \end{itemize}
  \end{rubriquetableau}
