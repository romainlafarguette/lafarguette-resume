...
\begin{itemize}[]
  \item Macroeconomist, involved in more than 30 country missions covering IMF program negotiations, Article IV, FSAP, technical assistance (including as mission chief), etc.
  \end{itemize}
 
\vspace{0.4cm}

\activite{European Central Bank} Researcher and Portfolio Manager \hfill Frankfurt, 2013-2016 \\
\vspace{-0.2cm}
