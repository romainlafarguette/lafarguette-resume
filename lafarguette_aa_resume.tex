...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
    \item Senior strategist and researcher with 12+ years of experience across sovereign wealth funds (GIC, ADIA), international financial institutions (IMF, ECB), and buy-side global macro teams.
    \item Focus on asset allocation, portfolio construction and global macro strategies.
  \end{itemize}
...
\activite{GIC} Lead Strategist, Global Macro \hfill
Singapore, since 2023 \\ \vspace{-0.4cm}
\begin{itemize}
  \item Senior vice-president, lead strategist on DM/EM rates, FX and cross-asset allocation.
  \item Develop and deploy quant models for asset allocation, portfolio construction and alpha research for rates and FX.
  \item Research themes: nowcast, forecast, regimes modeling, alternative data, counterfactual scenario analysis, cross-assets arbitrage, etc.
\end{itemize} 
...
\begin{itemize}[]
\item Supported ADIA CIO on asset allocation and portfolio construction.
...
\begin{itemize}[]
  \item International macroeconomist, involved in more than 30 country missions covering IMF program negotiations, Article IV, FSAP, technical assistance (including as mission chief), etc.
  \end{itemize}
 
\vspace{0.4cm}

\activite{European Central Bank} Portfolio Manager \hfill Frankfurt, 2013-2016 \\
\vspace{-0.2cm}
