...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  ...
  \item Quant development: signal productionalization, CI/CD, cloud computing, portfolio analytics
  \end{itemize}
...
\begin{itemize}
  ...
  \item Production: CI/CD, cloud platforms (AWS \& Databricks) and data management (SQL, Polars) 
\end{itemize} 
...
\begin{rubriquetableau}[0.98\textwidth]{Skills}
  ...
  \begin{itemize}
    ...
    \item \textbf{Tech stack:} Python, Github CI/CD, cloud computing (AWS \& Databricks), Airflow schedulers, polars
