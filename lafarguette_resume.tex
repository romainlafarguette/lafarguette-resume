%% Time-stamp: <2023-04-23 20:32:38 A13258Q>
...
Quantitative  researcher   in  macro-economics  finance,  fluent   in  Chinese
Mandarin,  English and  French.\\

Part of  ADIA's "Q"  team,  where we  develop
systematic trading  strategies, leveraging  big data, statistics,  and machine
learning.  Alpha  generation  via  systematic  trading  and
multi-assets allocation/total portfolio management for ADIA. \\ \smallskip

Combination of technical  skills in modeling, programming, and  finance with a
10-year international  policy experience with the  International Monetary Fund
and  the European  Central  Bank.  Missions to  25  countries. Mission  chief,
leading teams of 3 to 7 people on technical assistance missions.\\ \smallskip

Design   open-source  statistical   models   and   algorithms, available   on
\url{romainlafarguette.github.io/}\\
...
\item Alpha generation and asset allocation for total portfolio management
\item Multi-assets class, mid-frequency trading
\item Signal generation, features analysis, data curation
\item Forecasting, nowcasting, risk modeling, big data, machine learning, etc.
 \end{itemize}
 
\vspace{0.5cm}

\activite{International Monetary Fund,} Economist \& Technical Assistance Mission Chief \hfill 2016-2022 \\
\vspace{-0.2cm}
...
\item Mission chief, leading teams of 3 to 7 people on technical assistance
  missions  
\item Missions to 25 countries: macrofinancial surveillance
  and modeling, IMF lending programs and technical assistance to central banks  
 \end{itemize}
 
\vspace{0.5cm}

\activite{European Central Bank,} Economist \& Portfolio Manager \hfill 2013-2016 \\
\vspace{-0.2cm}
...
\activite{Computer:} Python, \textsf{R}, Matlab, SQL, Git \\ 
\end{rubriquetableau}
