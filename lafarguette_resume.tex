...
\item Guide a team of quants on multi-assets allocation and macro modeling
	\begin{itemize}
\item Portfolio construction: selection and optimization, risk management, backtesting
\item Macro quant: nowcasting, forecasting, macro risk, regimes modeling, etc.
\end{itemize}
 \end{itemize}
