%% Time-stamp: <2021-10-06 17:29:30 RLafarguette>
...
\vspace{-0.3cm}
\begin{itemize}[label={}, rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item \small{\emph{Specialized in density modeling, numerical simulations, resampling and bootstrapping}}
\end{itemize}
...
\begin{rubriquetableau}[0.95\textwidth]{Country Missions and Policy Work}\\
  ...
  \activite{Algeria} Mission chief, team of five people (2021)\\
  \vspace{\midreduce}
  \begin{itemize}[label={}]
    \item \small{Technical assistance on liquidity forecasting and
        financial modeling}
  \end{itemize}
