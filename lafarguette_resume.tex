%% Time-stamp: <2023-05-11 19:14:52 A13258Q>
...
for systematic trading. \\ \medskip
...
for macro-financial signals generation and portfolio construction. \\ \medskip
...
Monetary  Fund and  the European  Central Bank.\\ \medskip

I  also design  open-source statistical  models and  algorithms, available  on
\url{romainlafarguette.github.io/}. \emph{Note that, since I joined ADIA, I am
not allowed to release my new codes online but I am still very active.} \\
...
\activite{Abu  Dhabi  Investment  Authority,} Quantitative  Researcher and Developer  \hfill
Since 2022 \\ \vspace{-0.2cm}
\begin{itemize}[label={},
rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item  Buy-side macro-quant, ADIA quant team ("Q")
\item  Multi-asset  allocation and  portfolio  construction  for ADIA's  total portfolio
...
% SKILLS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{rubriquetableau}[12 cm]{Skills}\\
  \vspace{-0.5cm}
...
\activite{Programming:} Python (including environment management, remote deployment, testing, etc.), \textsf{R}, Matlab, SQL, Git, Linux \\

  \vspace{0.4cm}

\activite{Financial Platforms:} Bloomberg, Macrobond, Haver, CEIC, Wind, Refinitive, GFD
