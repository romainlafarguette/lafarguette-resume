...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead quant portfolio strategist with 13+ years of experience across GIC, ADIA, IMF \& ECB
...
\begin{itemize}
  ...
  \begin{itemize}
  \item Optimizing the balance between liquidity needs and long-term capital appreciation
  \end{itemize} 
  ...
  \item Mentor a team of six quants on asset allocation, portfolio construction and global markets analytics
\end{itemize} 
...
\begin{itemize}[]
\item Quantitative insights to the CIO to drive tactical tilts in global markets, with a focus on inflation hedging and sovereign risk
\item Macro quant research on global rates, FX, credit and commodity markets, sovereign risk, inflation, etc. 
 \end{itemize}
...
\begin{itemize}[]
  \item Macro analysis: sovereign risk, macro stress-tests, nowcasting, inflation forecasting, debt projections, etc.
