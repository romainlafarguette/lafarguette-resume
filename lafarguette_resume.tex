%% Time-stamp: <2021-09-16 20:36:22 RLafarguette>
...
Ph.D. quant economist and IMF technical assistance mission chief, fluent in Chinese Mandarin and English.\\
\smallskip

Specialized in advanced econometrics and statistical models applied to
financial and monetary issues, with a strong focus on central bank operations,
...
Design statistical modeling packages for central banks and researchers: \url{romainlafarguette.github.io/}\\ 
...
\item Mission chief, leading teams of 3 to 7 people on technical assistance
  missions
\item Former EP (IMF Economist Program)
 \end{itemize}
...
\begin{itemize}[label={},
  rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item \emph{Thesis on the FX market. Six years in China, entire curriculum in Chinese Mandarin}
\end{itemize}

\vspace{0.2cm}

\activite{M.Sc. Quantitative Economics,} Ecole Normale Supérieure
de Paris-Saclay \\
\vspace{-0.3cm}
\begin{itemize}[label={}, rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item \emph{Normalien, ranked first at France's national competition entrance exam}
\end{itemize}
...
\vspace{-0.3cm}
\begin{itemize}[label={}, rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item \emph{Philosophy of medicine, ethics}
\end{itemize}
\vspace{0.2cm}
...
\vspace{-0.3cm}
\begin{itemize}[label={}, rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item \emph{Specialized in density modeling, numerical simulations, resampling and bootstrapping}
\end{itemize}
...
\begin{rubriquetableau}[0.95\textwidth]{Country Missions and Policy Work}\\
...
\begin{rubriquetableau}[0.95\textwidth]{Open-Source Software Development}\\
