...
\item Macro signal generation: nowcasting, forecasting, risk modeling, etc.
 \end{itemize}
...
\activite{FX Intervention Rules: A Risk-Based Framework}, IMF Singapore Training Institute (STI) (2023)\\
  ...
  \item \small{Modeling under Python, with a package we developped with \href{https://amineraboun.github.io/}{Amine Raboun}: \href{https://pypi.org/project/varfxi/}{pypi link}. Link to the \href{https://romainlafarguette.github.io/STI_FX_Intervention/docs/index.html}{course}}
  \end{itemize}
