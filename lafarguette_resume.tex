...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead quantitative portfolio strategist with 13+ years of experience across GIC, ADIA, IMF \& ECB
...
\begin{itemize}
  ...
  \begin{itemize}
  \item Optimize the balance between liquidity needs and long-term capital appreciation
  \end{itemize} 
...
\begin{itemize}[]
\item Quantitative models to support CIO strategic allocation and tactical tilts, inflation hedging and sovereign risk
