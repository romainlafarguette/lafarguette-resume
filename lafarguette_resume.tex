%% Time-stamp: <2021-08-06 10:31:18 rlafarguette>
...
Statistical software for forecasting and financial modeling: \url{https://romainlafarguette.github.io/}\\ 
...
\activite{International Monetary Fund,} Economist \hfill 2016-Present \\
\vspace{-0.2cm}

\begin{itemize}[label={},
  rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]

\item Monetary and Capital Markets department \& European department
\item Mission chief, leading teams of 3 to 7 people on technical assistance
  missions
\item Missions to more than 20 countries, including to the P.R. China, Hong
  Kong, India, South Korea, Malaysia, Singapore, the United Arab Emirates, etc.
\item Macrofinancial surveillance, IMF lending programs and technical assistance 
 \end{itemize}
...
\activite{M.Res. in Economics, Normalien,} Ecole Normale Supérieure de Paris-Saclay\\
\vspace{0.2cm}
