...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  ...
  \item Key expertise: portfolio management and analytics, global markets, quant \& academic research, policy work
  \end{itemize}
...
\begin{itemize}
  \item Lead and mentor a team of six quants on global markets, risk modeling and portfolio construction.
  \item Develop and implement portfolio systems and analytics for \$100+ bn multi-asset portfolios.
  \item Steer quant models systems using Machine Learning/AI/LLM on rates, FX, and credit markets
  \item Design and oversee portfolios risk tools (multivariate risk factors, stress-tests, early warning signals) 
\end{itemize} 

\vspace{0.4cm}

\activite{ADIA} Senior Quant Researcher, Portfolio Construction \& Macro Research  \hfill
...
\activite{International Monetary Fund} Financial Sector Expert \hfill Washington DC, 2016-2022 \\
\vspace{-0.2cm}

\begin{itemize}[]
  \item Led technical assistance missions to 30+ countries on quantitative models for financial operations.
  \begin{itemize}
  \item Developed risk and liquidity management frameworks and FX reserves management tools
  \end{itemize}
  \item Policy work on IMF funding programs and financial surveillance for EM countries
  \item Academic publications on macro risk modeling (Growth-at-Risk), forecasting, nowcasting 
  \end{itemize}  
...
\begin{itemize}[]
  ...
  \begin{itemize}
  \item Portfolio management and risk modeling for rates and FX portfolios 
  \item Direct exposure to monetary policy implementation and large-scale QE programs
  \end{itemize}
\end{itemize}
\end{rubriquetableau}
...
\begin{rubriquetableau}[0.98\textwidth]{Skills}
  \vspace{-0.5cm}  
  \begin{itemize}
    \item \textbf{Analytics:} Optimization, simulation, density modeling, machine learning, AI \& LLM
    \item \textbf{Risk quantification}: VaR, CVaR, ES, stress-testing, credit \& FX risk modeling, pricing tools
    \item \textbf{Risk factors models}: Blackrock BRS, MSCI Barra, PCA-custom models
    \item \textbf{Programming:} Python (quant libraries, CI/CD, AWS), SQL, Databricks (platform)
    \item \textbf{Data:} Bloomberg, Factset, Macrobond, CEIC, alternative datasets
