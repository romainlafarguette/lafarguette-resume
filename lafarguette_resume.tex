...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead quantitative portfolio strategist with 13+ years of experience in global macro teams
  \item Machine learning \& AI for asset allocation and global markets analytics, team leadership
  \item Quant systems: cloud computing (AWS \& Databricks), DAG orchestration, portfolio analytics and reporting  
  \end{itemize}
...
\activite{GIC} Lead Quant Portfolio Strategist, Senior Vice President \hfill
Singapore, since 2023 \\ \vspace{-0.4cm}
\begin{itemize}
  \item Mentor a team of six quants focused on asset allocation and sophisticated portfolio construction
  \item Engineer asset allocation framework and risk analytics for \$100+ bn multi-asset portfolios
  \begin{itemize}
  \item Optimize between returns opportunities, diversified exposures, risk tolerance and constraints
  \end{itemize} 
  \item Steer Machine Learning/AI/LLM quant models on rates, FX, and credit markets for portfolio positioning
  \item Architect institutional-grade portfolio risk tools (multivariate risk factors, stress-tests, early warning signals) 
\end{itemize} 

\vspace{0.4cm}

\activite{ADIA} Senior Quant Portfolio Strategist, Senior Researcher  \hfill
Abu Dhabi, 2022-2023 \\ \vspace{-0.2cm}
\begin{itemize}[]
\item Quantitative models to support CIO strategic allocation and tactical tilts, inflation and sovereign risk hedging
\item Advanced macro research across global rates, FX, and commodity to identify long-term investment themes
 \end{itemize}
...
\begin{itemize}[]
  ...
  \item Financial surveillance for EM \& low-income countries and negotiations for IMF programs 
  \item Mission chief and technical contributor on technical assistance missions to 30+ countries 
  \end{itemize}  
\vspace{0.4cm}

\activite{European Central Bank} Quant and Portfolio Manager \hfill Frankfurt, 2013-2016 \\
\vspace{-0.2cm}
...
Policy experience across 30+ country missions on technical assistance, policy negotiations and financial surveillance\\

\begin{multicols}{2}

\textbf{\large Asia, Europe and LATAM}
\begin{itemize}
