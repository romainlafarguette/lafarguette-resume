%% Time-stamp: <2023-05-11 18:02:28 A13258Q>
...
\begin{etatcivil}
\begin{flushleft}
  \emph{Updated: \monthyeardate\today}\\
...
I am  part of ADIA's  "Q" team; I  work both on  multi-assets allocation/total
portfolio management  for ADIA as well  as on alpha generation  for systematic
trading. I use both standard and alternative data, statistics (frequentist and
Bayesian), and machine learning, mostly in time series space. I develop Python
tools for  macro-financial signals  generation and portfolio  construction. \\
\smallskip
...
Monetary  Fund and  the European  Central Bank.   I have  done missions  to 25
countries, as  a quant  economist.  I  was also a  mission chief  on technical
assistance missions, where  I led teams of  3 to 7 people to  teach and deploy
quantitative  tools  I  developped  to   central  banks  on  foreign  reserves
management and liquidity management.\\ \smallskip

I  also design  open-source statistical  models and  algorithms, available  on
\url{romainlafarguette.github.io/}. \emph{Note that, since I  joined ADIA, I am  not allowed to
release my new codes online.} \\
...
\activite{Abu Dhabi Investment Authority,} Quantitative Researcher \hfill Since 2022 \\
\vspace{-0.2cm}
\begin{itemize}[label={},
rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item Buy-side macro-quant, sovereign wealth fund of Abu Dhabi (ADIA), "Q team" 
\item Multi-asset allocation and construction portfolio for ADIA's total portfolio using quantitative tools
\item Macro-signal generation, modeling and features analysis, data curation
\item Forecasting, nowcasting, risk modeling, big data, machine learning, etc.
 \end{itemize}
 
\vspace{0.5cm}

\activite{International Monetary Fund,} Quant Economist \& Technical Assistance Mission Chief \hfill 2016-2022 \\
\vspace{-0.2cm}

\begin{itemize}[label={}, rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item Monetary and Capital Markets Department
\item Quant and mission chief, leading teams of 3 to 7 people on technical assistance
  missions  
\item Missions to 25 countries: macrofinancial  modeling, IMF lending programs and technical assistance to central banks on quantitive methods
  ...
  \item Monetary and financial modeling
  \end{itemize}
 \end{itemize}
 
\vspace{0.5cm}

\activite{European Central Bank,} Quant Economist \& Portfolio Manager \hfill 2013-2016 \\
\vspace{-0.2cm}
...
\item Mathematical portfolio optimization, risk modeling, exchange rate
  forecasting  
\item Negotiations with the People's Bank of China for the ECB RMB portfolio
\end{itemize}
\end{rubriquetableau}
...
\begin{itemize}[label={},
  rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item \small{\emph{Six years in Beijing, entire curriculum
...
% CONSULTANCY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{rubriquetableau}[0.95\textwidth]{Teaching Missions}
  \vspace{-0.2cm}
  
  \activite{Singapore}, IMF Singapore Training Institute (STI) (2023)\\
  \vspace{\midreduce}
  \begin{itemize}[label={}]
  \item \small{IMF 1-week training on FX Intervention Rules: A Risk-Based Framework}
  \item \small{29 participants from 14 central banks}    
  \item \small{Modeling and forecasting under Python, with a package we developped with Amine Raboun: \href{https://pypi.org/project/varfxi/}{pypi link}. Link to the \href{https://amineraboun.github.io/STI_FX_Intervention/docs/index.html}{course}}
  \end{itemize}

  \activite{Singapore} IMF Singapore Training Institute (STI) (2022)\\
  \vspace{\midreduce}
  \begin{itemize}[label={}]
  \item \small{IMF 1-week training on Forecasting Framework Central Bank Systemic Liquidity}
  \item \small{16 participants from 12 central banks}
...
\small
\activite{FX Intervention Rules: A Risk-Based Framework (2023)} \\
\hspace{0.6cm} \small{\emph{IMF Singapore Training Center (STI), Singapore}}
\vspace{0.4cm}

\small
\activite{Forecasting Framework Central Bank Systemic Liquidity (2022)} \\
\hspace{0.6cm} \small{\emph{IMF Singapore Training Center (STI), Singapore}}
\vspace{0.4cm}
...
\activite{Computer:} Python (including environment management, remote deployment, testing, etc.), \textsf{R}, Matlab, SQL, Git \\ 
\end{rubriquetableau}
