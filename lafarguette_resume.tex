%% Time-stamp: <2022-08-15 18:34:52 A13258Q>
...
Quantitative researcher  in finance, fluent  in Chinese Mandarin,  English and
French.  Specialized in  machine learning  and statistical  models applied  to
financial and monetary issues.\\ \smallskip
...
\activite{Abu Dhabi Investment Authority,} Quantitative Researcher \hfill Since 2022 \\ \vspace{-0.2cm}
\begin{itemize}[label={},
rightmargin=\dimexpr\linewidth-13cm-\leftmargin\relax]
\item Buy-side quant, sovereign wealth fund of Abu Dhabi (ADIA), "Q team" 
\item Machine learning, big data, statistical inference, macro quant modeling
 \end{itemize}
...
\activite{Computer:} Python, \textsf{R}, Matlab \\ 
\end{rubriquetableau}
