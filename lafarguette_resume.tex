...
I  am a  quant senior vice president specialized in asset allocation, portfolio construction and macro-quant modeling in \href{https://www.gic.com.sg/}{GIC}, the sovereign  wealth fund of
Singapore.\\ \medskip

I work for the \href{https://www.gic.com.sg/how-we-invest/investment-groups/}{Fixed Income and Multi-Assets (FIMA)} department, where I develop quantitative models for portfolio construction and assets allocation, supporting the daily management of USD multi-billions portfolios. \\ \medskip

I also design and implement quantitative macroeconomic signals (forecasting, nowcasting, regimes, etc.) and use density modeling and optimization methods for asset allocation. I handle backtesting, package deployment and some quant production-related issues. \\ \medskip
...
\activite{GIC} Quant Senior Vice-President \hfill
...
\item Portfolio construction and asset allocation for macro portfolios (multi-assets, rates, equity indices, FX, commodities, quant) and spreads portfolios (corp, loans, converts, structured products, alternative products incl. private assets) 
\item Portfolio optimization, simulation, stress-testing, backtesting, density modeling and macro signals research (regimes, nowcasts, forecasts, curve models, etc.)
 \end{itemize}
...
\activite{International Monetary Fund,} Quant Economist \hfill Washington DC, 2016-2022 \\
\vspace{-0.2cm}
