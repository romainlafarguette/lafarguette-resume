%% Time-stamp: <2021-08-30 11:34:46 RLafarguette>
...
Ph.D. economist and engineer, fluent in Chinese Mandarin, French and English.\\
\smallskip
...
Wide range of policy experience, covering portfolio management, IMF program negotiations,
technical assistance in central banking, and macrofinancial surveillance and
...
Design open-source forecasting and modeling packages: \url{https://romainlafarguette.github.io/}\\ 
...
\activite{International Monetary Fund,} Quant Economist and Mission Chief \hfill 2016-Present \\
\vspace{-0.2cm}
...
\item Missions to more than 20 countries, covering macrofinancial surveillance
  and modeling, IMF lending programs and technical assistance   
...
\activite{European Central Bank,} Economist and Portfolio Manager \hfill 2013-2016 \\
\vspace{-0.2cm}
...
\item Mathematical portfolio optimization, risk modeling, exchange rate forecasting 
\end{itemize}
\end{rubriquetableau}
...
\activite{Ph.D. in Economics,} Peking University and Paris School of Economics\\
\vspace{-0.3cm}

\activite{M.Res. Normalien,} Ecole Normale Supérieure de Paris-Saclay \\
\vspace{0.2cm}
...
%   \vspace{-0.3cm}
%   \begin{itemize}[label={}]
%     \item \small{Technical assistance on the calibration of central bank operations, liquidity forecasting}
%   \end{itemize}

%   \activite{Namibia} Mission chief, team of four people (2021)\\
%   \vspace{-0.3cm}
%   \begin{itemize}[label={}]
%     \item \small{Technical assistance on central bank liquidity forecasting}
%   \end{itemize}
...
%   \vspace{-0.3cm}
%   \begin{itemize}[label={}]
%     \item \small{Financial Sector Assessment Program: Systemic Liquidity and Stress-Testing}
%   \end{itemize}
