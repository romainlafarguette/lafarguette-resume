...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead macro quantitative strategist with 13+ years of experience across IMF, ECB, GIC \& ADIA
  \item Machine learning \& AI for macroeconomics and finance, team leadership and sovereign-level policy work 
  \end{itemize}
...
\activite{GIC} Lead Global Macro Quant Strategist, Senior Vice President \hfill
Singapore, since 2023 \\ \vspace{-0.4cm}
\begin{itemize}
  \item Mentor a team of six quants on macroeconomic modeling, global market analysis and asset allocation 
  \item Steer macro quant models using Machine Learning/AI/LLM on rates, FX, and credit markets
  \item Design and oversee macro systems (early warning signals, forecasting, sovereign risk, debt projection, etc.) 
...
\activite{ADIA} Senior Global Macro Quant Strategist, Senior Researcher  \hfill
Abu Dhabi, 2022-2023 \\ \vspace{-0.2cm}
\begin{itemize}[]
\item Macro quant research on global rates, FX, credit and commodity markets, sovereign risk, inflation, growth
\item Asset allocation, risk and portfolio construction, supporting ADIA CIO's strategic and tactical allocation
 \end{itemize}
...
\begin{itemize}[]
  ...
  \begin{itemize} 
    \item Central banks' FX \& liquidity management, debt projections, macro forecasting, risk modeling, etc.
  \end{itemize}  
  \end{itemize}  
\vspace{0.4cm}
