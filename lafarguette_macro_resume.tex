...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead macro quant researcher with 13+ years of experience across IMF, ECB, GIC \& ADIA
  \item Macro and financial modeling, academic research and sovereign-level policy work 
  \end{itemize}
...
\activite{GIC} Lead Researcher, Global Macro, Senior Vice President \hfill
Singapore, since 2023 \\ \vspace{-0.4cm}
\begin{itemize}
  \item Mentor a team of six researchers on macroeconomic modeling and global market analysis 
  \item Steer macro models using Machine Learning/AI/LLM on fixed income markets and macro fundamentals
