...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead macro quant strategist with 13+ years of experience across international financial institutions 
  \item Key expertise: macroeconomics modeling, global markets, quant \& academic research, policy work
  \end{itemize}
...
\activite{GIC} Lead Global Macro Strategist, Senior Vice-President \hfill
...
\begin{itemize}
  ...
  \item Design and oversee macro systems (early warning signals, forecasting \& nowcasting, debt projection, etc.) 
