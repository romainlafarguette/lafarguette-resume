...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  ...
  \item Quant research: stats, ML, portfolio construction \& optimization, factors and risk models
...
\begin{itemize}
  \item Lead a team of 5 quant researchers in global macro and asset allocation
  ...
  \item Macro-factor signal aggregation framework with optimization, custom constraints and risk limits
  \item Maintain risk-factor platform (Barra + PCA) for real-time stress-testing and tail-risk monitoring
  \item Production: CI/CD, cloud platforms (AWS \& Databricks) and data management (SQL, Spark, Polars) 
\end{itemize} 

\vspace{0.4cm}

\activite{ADIA} Quant Researcher and Developer  \hfill
Abu Dhabi, 2022-2023 \\ \vspace{-0.2cm}
\begin{itemize}[]
\item Data curation for the quant team Q, with a focus on macro datasets (both traditional and alternative) and real-time data management
\item Contribution to focused squads on dynamic asset allocation, China, FX, etc. 
 \end{itemize}
