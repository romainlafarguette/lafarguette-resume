...
\begin{rubriquetableau}[0.95\textwidth]{Summary}\\
  \vspace{-1cm}
  \begin{itemize}
  \item Lead macro-economist and strategist with 13+ years of experience across the IMF, ECB, GIC, and ADIA.
...
\activite{International Monetary Fund} Quant Macroeconomist \& TA Mission Chief \hfill Washington DC, 2016-2022 \\
\vspace{-0.2cm}
\begin{itemize}[]
  \item \textbf{Mission leadership}: Served as mission chief and technical lead on 30+ TA missions globally, specializing in central bank FX and liquidity operations, debt management, and financial surveillance.
...
\begin{rubriquetableau}[0.98\textwidth]{Areas of Expertise \& Skills}
  ...
  \begin{itemize}
    ...
    \item \textbf{Tech Stack for Research:} Python (applied to macro-modeling), GitHub for collaborative research, Cloud computing (Databricks/AWS) for big data macro analytics.
    \item \textbf{Data Systems:} Expert proficiency in Bloomberg, Macrobond, Haver Analytics, CEIC, and Wind (China macro data).
    \item \textbf{Languages:} French (Native), English (Fluent), Mandarin Chinese (Conversational/Professional - Ph.D. level).
  \end{itemize}
  \end{rubriquetableau}
